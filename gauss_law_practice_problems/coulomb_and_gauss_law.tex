...
%\FloatBarrier
%-------------------------------------------------------------------------------
%Inspect the equation $\Phi_E=\oint \bm E \cdot \text d\bm A$ carefully for what it means, and note that when you integrate over the whole surface, there can be cancellation of flux going \textit{into} with flux going \textit{out of} the surface.
